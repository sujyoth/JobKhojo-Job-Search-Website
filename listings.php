...
<div style="padding-left: 10px;">
  <h2 >Create Listing</h2><form name="search" method="POST" action="//localhost/create_listing.php">
  <input style="width: 50%" class="w3-input" type="text" name="company" placeholder="Company Name"><br>
  <input style="width: 50%" class="w3-input" type="text" name="industry" placeholder="Industry"><br>
  <input style="width: 50%" class="w3-input" type="text" name="designation" placeholder="Designation"><br>
  <input style="width: 50%" class="w3-input" type="number" name="experience" placeholder="Minimun Experience in Years"><br>
  <input style="width: 50%" class="w3-input" type="text" name="salary" placeholder="Expected Salary Per Annum"><br>
  <select style="width: 50%" name="education" id="education" class="w3-input">
            <option disabled="disabled" selected="selected" value="">Minimum Education</option>
          ...
          <br>
           ...
           <select name="city" style="width: 50%" class="w3-input">
  ...
  <button class="btn btn-warning" style="margin-left: 570px" type="submit"> Add Listing</button></form><br><br>
</div>



   <footer style="height: 90px; background-color: skyblue">
  </a><br>
