...
<body >
  ...
  <div class="container">
    ...
    <a href="//localhost/listings.php">Create Listing</a>
...
<div style="padding-left: 10px;">
  <h2 >Find jobs that suit you.</h2>
  <input style="width: 50%" class="w3-input" type="text" name="company" id="company" placeholder="Company Name"><br>
  <input style="width: 50%" class="w3-input" type="text" name="industry" id="industry" placeholder="Industry"><br>
  <input style="width: 50%" class="w3-input" type="text" name="designation" id="designation" placeholder="Designation"><br>
  <input style="width: 50%" class="w3-input" type="number" name="experience" id="experience" placeholder="Minimun Experience in Years"><br>
  <input style="width: 50%" class="w3-input" type="text" name="salary" id="salary" placeholder="Expected Salary Per Annum"><br>
  <select style="width: 50%" name="education" id="education" class="w3-input">
            <option selected="selected" value="">Minimum Education</option>
          ...
          <br>
           ...
           <select name="city" id="city" style="width: 50%" class="w3-input">
  ...
  <button style="margin-left: 570px" onclick="loadDoc()"><i class="fa fa-search"></i> Search Jobs</button><br><br>
</div>
<div id="demo">
</div>
...
xhttp.open("GET", "//localhost/jobsearcher.php?company="+com+"&industry="+ind+"&designation="+des+"&experience="+exp+"&salary="+sal+"&education="+edu+"&city="+cit, true);
xhttp.send();
}
